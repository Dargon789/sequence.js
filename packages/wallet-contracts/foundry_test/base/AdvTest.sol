...
contract AdvTest is Test {
    ...
    function boundDiff(uint256 _a, uint256 _b, uint256 _c, uint256 _d, uint256 _e, uint256 _f)
        internal
        pure
        returns (uint256)
    {
    ...
    function boundDiff(uint256 _a, uint256 _b, uint256 _c, uint256 _d, uint256 _e, uint256 _f, uint256 _g)
        internal
        pure
        returns (uint256)
    {
    ...
    function boundDiff(uint256 _a, uint256 _b, uint256 _c, uint256 _d, uint256 _e, uint256 _f, uint256 _g, uint256 _h)
        internal
        pure
        returns (uint256)
    {
