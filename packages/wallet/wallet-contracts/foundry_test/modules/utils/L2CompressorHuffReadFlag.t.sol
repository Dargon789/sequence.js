...
contract L2CompressorHuffReadFlagTests is AdvTest {
    ...
    function setUp() public {
        imp = address(HuffDeployer.config().with_evm_version("paris").deploy("imps/L2CompressorReadFlag"));
    }

    function test_read_flag_bytes32_one(uint8 _val) external {
        (bool s, bytes memory r) = imp.staticcall(abi.encodePacked(hex"01", _val));
    ...
    function test_read_flag_bytes32_two(uint16 _val) external {
        (bool s, bytes memory r) = imp.staticcall(abi.encodePacked(hex"02", _val));
    ...
    function test_read_flag_bytes32_x(uint256 _size, bytes memory _content) public {
        ...
        (bool s, bytes memory r) = imp.staticcall(abi.encodePacked(uint8(_size), _content));
    ...
    function test_read_flag_save_and_read_address(address _addr2) external {
        ...
        (bool s, bytes memory r) = imp.call(abi.encodePacked(hex"21", _addr));
        ...
        (s, r) = imp.staticcall(abi.encodePacked(hex"23", uint16(1)));
        ...
        (s, r) = imp.call(abi.encodePacked(hex"21", _addr2));
        ...
        (s, r) = imp.staticcall(abi.encodePacked(hex"24", uint24(2)));
        ...
        (s, r) = imp.staticcall(abi.encodePacked(hex"25", uint32(2)));
    ...
    function test_read_flag_save_and_read_bytes32(bytes32 _b1, bytes32 _b2) external {
        (bool s, bytes memory r) = imp.call(abi.encodePacked(hex"22", _b1));
        ...
        // Read the address at index 1
        (s, r) = imp.staticcall(abi.encodePacked(hex"27", uint16(1)));
        ...
        // Save a second address
        (s, r) = imp.call(abi.encodePacked(hex"22", _b2));
        ...
        // Read second address using 3 bytes, 4 bytes and 5 bytes
        (s, r) = imp.staticcall(abi.encodePacked(hex"28", uint24(2)));
        ...
        (s, r) = imp.staticcall(abi.encodePacked(hex"29", uint32(2)));
    ...
    function test_read_flag_bytes_n(bytes calldata _data, bytes calldata _extra) external {
        (bool s, bytes memory r) =
            imp.staticcall(abi.encodePacked(hex"2b", hex"04", uint32(_data.length), _data, _extra));
    ...
    function test_read_flag_abi_encode_4(bytes4 _selector, bytes32 _v1, bytes32 _v2, bytes32 _v3, bytes32 _v4)
        external
    {
    ...
    function test_read_nested(bytes memory _dynamic, uint256 _val1, uint256 _val2) external {
        bytes memory encoded =
            encode_nested(encode_bytes_n(_dynamic), encode_nested(encodeWord(_val1), encodeWord(_val2)));
    ...
    function test_read_dynamic_signature(uint8 _weight, address _signer, bytes memory _signature) external {
        ...
        assertEq(
            res,
            abi.encodePacked(uint8(2), uint8(_weight), _signer, uint24(_signature.length + 1), _signature, uint8(3))
        );
    }

    function test_read_sequence_signature(bool _noChainId, uint16 _threshold, uint32 _checkpoint, bytes memory _tree)
        external
    {
    ...
    function test_read_abi_dynamic_no_dynamic(bytes4 _selector, bytes32[] calldata _values) external {
    ...
    function test_read_abi_dynamic_only_1(bytes4 _selector, bytes memory _data1) external {
    ...
    function test_read_abi_dynamic_only_2(bytes4 _selector, bytes memory _data1, bytes memory _data2) external {
    ...
    function test_read_abi_dynamic_only_8(
        ...
        assertEq(res, abi.encodeWithSelector(_selector, _data1, _data2, _data3, _data4, _data5, _data6, _data7, _data8));
    }

    function test_read_mixed_2(bytes4 _selector, bytes32 _data1, bytes memory _data2) external {
        bool[] memory isDynamic = new bool[](2);
        bytes[] memory _values = new bytes[](2);
    ...
    function test_read_mixed_2b(bytes4 _selector, bytes memory _data1, bytes32 _data2) external {
        bool[] memory isDynamic = new bool[](2);
        bytes[] memory _values = new bytes[](2);
    ...
    function test_mirror_flag() external {
        bytes memory encoded = abi.encodePacked(
            encode_nested(encodeWord(type(uint256).max - 1), abi.encodePacked(uint8(0x4d), uint16(0x02)))
        );
    ...
    function test_copy_calldata() external {
        bytes memory encoded = abi.encodePacked(
            encode_nested(encodeWord(type(uint256).max - 1), abi.encodePacked(uint8(0x4e), uint16(0x03), uint8(0x21)))
        );
    ...
    function test_read_storage_flag_addr(address _addr) external {
        _addr = address(this);
        bytes memory encoded = abi.encodePacked(
            encode_nested(abi.encodePacked(uint8(0x21), _addr), abi.encodePacked(uint8(0x4f), uint16(0x02)))
        );
    ...
    function test_read_self_execute() external {
        ...
        bytes memory encoded = abi.encodePacked(uint8(0x00), uint8(0x00), uint8(_txs.length));
